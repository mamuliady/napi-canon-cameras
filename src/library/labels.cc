...
namespace CameraApi {
    ...
    const LabelMap &Labels::ObjectEventID() {
    ...
    const LabelMap &Labels::StateEventID() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::PropertyID() {
        static const LabelMap map = {
...
// CFn not available on macOS
    ...
    const LabelMap &Labels::BatteryQuality() {
        static const LabelMap map = {
            {0, "Low"},
            {1, "Half"},
            {2, "High"},
    ...
    const LabelMap &Labels::AEModeSelect() {
        static const LabelMap map = {
            {kEdsAEMode_Program, "ProgramAE"},
            {kEdsAEMode_Tv, "Tv"},
            {kEdsAEMode_Av, "Av"},
    ...
    const LabelMap &Labels::EvfAFMode() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::EvfHistogramStatus() {
        static const LabelMap map = {
            {0, "Hide"},
            {1, "Normal"},
            {2, "Grayout"},
    ...
    const LabelMap &Labels::EvfOutputDevice() {
        static const LabelMap map = {
            {0x00, "None"},
    ...
    const LabelMap &Labels::ImageQuality() {
        static const LabelMap map = {
            ...
            {
                EdsImageQuality_LRS1JN, "RAWAndSmall1JPEGNormal"
    ...
    const LabelMap &Labels::ColorSpace() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::DCStrobe() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::DriveMode() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::MeteringMode() {
        static const LabelMap map = {
            {1, "Spot"},
            {3, "Evaluative"},
            {4, "Partial"},
    ...
    const LabelMap &Labels::MirrorUpStatus() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::MovieQuality() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::NoiseReduction() {
        static const LabelMap map = {
            {0, "Off"},
            {1, "On1"},
            {2, "On2"},
    ...
    const LabelMap &Labels::LensBarrelStatus() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::LensStatus() {
        static const LabelMap map = {
            {0, "NotAttached"},
            {1, "Attached"}
        };
    ...
    const LabelMap &Labels::PictureStyle() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::WhiteBalance() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::Error() {
        static const LabelMap map = {
            ...
            },
            {
                ...
                "NOT_CAMERA_SUPPORT_SDK_VERSION"
            },
            ...
            {EDS_ERR_TAKE_PICTURE_MIRROR_UP_NG, "TAKE_PICTURE_MIRROR_UP_NG"},
            {
                ...
                "TAKE_PICTURE_SENSOR_CLEANING_NG"
            },
    ...
    const LabelMap &Labels::ImageFormat() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::ImageSize() {
        static const LabelMap map = {
    ...
    const LabelMap &Labels::ImageCompression() {
        static const LabelMap map = {
    ...
    const std::unordered_map<int, LabelMap> &Labels::Option() {
        static const std::unordered_map<int, LabelMap> map = {
            {kEdsPropID_AEMode, AEMode()},
            {kEdsPropID_AEModeSelect, AEModeSelect()},
            {kEdsPropID_AFMode, AFMode()},
            {kEdsPropID_Aspect, Aspect()},
